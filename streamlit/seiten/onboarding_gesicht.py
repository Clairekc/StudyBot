...
#
#  VEREINFACHT: 3 Fotos (vorne, links, rechts)
#  Kein Richtungscheck — nur Gesicht muss erkannt werden
#  Snapshot-Ansatz: stabil, einfach, funktioniert
# ============================================================
...
def _snapshot():
    """Öffnet Kamera, liest 5 Frames (Helligkeit stabilisieren), gibt besten zurück."""
